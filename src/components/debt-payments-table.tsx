...
export function DebtPaymentsTable() {
  ...
  const paymentItems = useMemo(() => budgetItems.filter(item => item.type === 'Debt Payments'), [budgetItems]);
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will clear all synced debt payments.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  <AlertDialogCancel>Cancel</AlertDialogCancel>
                  <AlertDialogAction onClick={() => {}} className={cn(buttonVariants({ variant: "destructive" }))}>
                    Yes, Clear All
                  </AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
